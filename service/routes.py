...
def list_accounts():
    ...
    # return jsonify(accounts=[account.serialize() for account in Account.find_all()]), status.HTTP_200_OK
    return jsonify(results=[account.serialize() for account in Account.all()]), status.HTTP_200_OK
